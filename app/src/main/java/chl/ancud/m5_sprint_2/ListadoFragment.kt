...
import chl.ancud.m5_sprint_2.databinding.ActivityMainBinding
import chl.ancud.m5_sprint_2.databinding.FragmentListadoBinding
...
class ListadoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentListadoBinding.inflate(LayoutInflater.from(activity))
    ...
    private fun initAdapter() {
        val adapter = Adapter()
        val lista = ListadoZapatos.zapatos
